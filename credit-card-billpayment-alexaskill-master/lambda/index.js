...
const BlockCardIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        const speakOutput = "Sorry " + sany.name + ' ,your '+ card + " has been blocked.";
...
const CreditCardBillIntentHandler = {
    ...
    handle(handlerInput) {
        var speakOutput = "Your credit card bill this month is " + credit.currency +" "+ credit.fullamount +" ." + " Would you like to pay the credit card bill?" ;
